...
@section('main')
  ...
  <div class="thumnail"><img class="bg-mentor-detail" src="{{asset('home_page')}}/img/bg-mentor-detail.png" alt=""></div>
      <div class="mentor-detail position-relative">
          <div class="container">
              <div class="row">
                  <div class="col-md-4">
                    <div class="img-mentor my-3">
                        <img src="{{$mentor->image()}}" class="border border-light border-2 rounded-circle">
                    </div>
